...
1. Check that the bug has not already been reported: https://github.com/Komal-ai417/hiring-agent/issues
2. Open a new bug report: https://github.com/Komal-ai417/hiring-agent/issues/new
3. Please include:
...
1. Check for existing requests: https://github.com/Komal-ai417/hiring-agent/issues
2. Open a new feature request: https://github.com/Komal-ai417/hiring-agent/issues/new
3. Describe the problem, the proposed solution, and any alternatives you considered.

## Contributing Code

1. Pick an issue from https://github.com/Komal-ai417/hiring-agent/issues or open one first.
